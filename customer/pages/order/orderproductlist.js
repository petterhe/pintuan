...
Page({
  ...
  initViewLayout: function () {
    ...
    if (app.globalData.isIpx) {
      mscrollheight = app.globalData.systemInfo.windowHeight - (160 + 68) * pxTorpxScale
    } else {
      mscrollheight = app.globalData.systemInfo.windowHeight - 160 * pxTorpxScale
    }
  ...
  */
  requestProductData: function () {
    ...
    request.requestGet(api.GetOrderProductSumService, data, _success, _fail, null)
